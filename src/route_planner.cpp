...
void RoutePlanner::AddNeighbors(RouteModel::Node *current_node) 
{
    ...
    {
        RouteModel::Node* current_neighbor = current_node->neighbors[i];
        if(current_neighbor->visited == false)
        {
            // Set Neighbor parent
            current_neighbor->parent = current_node;
            // Set H value to neighbor
            current_neighbor->h_value = CalculateHValue(current_neighbor);
            // Set g value to neighbor
...
RouteModel::Node *RoutePlanner::NextNode() 
{
    ...
    RouteModel::Node* low_node = nullptr;
    low_node = open_list.back();
    open_list.pop_back();
    return low_node;
}
...
std::vector<RouteModel::Node> RoutePlanner::ConstructFinalPath(RouteModel::Node *current_node) {
    ...
    // If the node has no parent it's start and I add in my collection
    path_found.push_back(*current_node);
    
    // Reverse my collection to have the right order
    // cplusplus.com/reference/algorith/reverse
...
void RoutePlanner::AStarSearch() 
{
    ...
    // TODO: Implement your solution here.
    // Add to my collection the start node and set to visited
